...
from src.exception import MyException, logging
...
class VehicleData:
    ...
    def get_vehicle_data_as_dict(self):  
        """
        This function return a dictionary from vehicle class input
        """
        ...
        try:
            input_data = {
                ...
                "Vehicle_Age_gt_2_Year":[self.Vehicle-Age-gt_2_years],
                "Vehicle_Damage_Yes":[self.Vehicle_Damage_Yes]}

            logging.info("Created vehicle data dict")
            logging.info("exited get_vehicle_data_as-dict method as VehicleData class")
            return input_data 
