...
from src.entity.estimators import MyModel
...
class ModelTrainer:
    ...
    def get_model_object_and_report(self,train: np.array, test: np.array) -> Tuple[object, object]:
         ...
         """
         try:
             logging.info("training RandomForestClassifier with specified parametrs")

             # Splitting the train and test data into features and tarrget variables
             ...
             model = RandomForestClassifier(
                 ...
                 min_samples_leaf= self.model_trainer_config._max_depth,
             ...
             logging.info("model traing done.")
             ...
             metrics_artifact = ClassificationMetricsArtifact(f1_score, precision_score = precision, recall_score = recall)
