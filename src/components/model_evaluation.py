...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[Proj1Estimator]:
        ...
        output:  Return model object if available in s3 storage
    ...
    def _rename_columns(self, df):
        ...
        for col in ['Vehicle_Age_1_Year', 'Vehicle_Age_gt_2_Years', 'Vehicle_Damage_Yes']:
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        ...
        output : Return bool values on validation results
        On Failure : Write an exception log and then raise an Exception
        """
        try:
            ...
            trained_model = load_object(file_path=self.model_trainer_artifact.trained_model_fit_path)
